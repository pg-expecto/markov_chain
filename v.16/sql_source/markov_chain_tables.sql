...
-- Вставка начальной конфигурации для тестовой СУБД
INSERT INTO markov_config (
    alpha,
    interval_minute,
    transition_log_retention_days,
    apply_forgetting_log_retention_days,
...
SELECT
    0.1,               -- alpha
    360,               -- interval_minute
    30,                -- transition_log_retention_days
    30,                -- apply_forgetting_log_retention_days
    true,              -- adaptive_forgetting_enabled
    true,              -- use_adaptive_alpha
    0.05,              -- base_alpha
    0.001,             -- min_alpha
    30,                -- incident_half_life_days
    5000,              -- min_transitions_for_forgetting
    10,                -- forecast_horizon_minutes
    300                -- min_freq_for_stability
