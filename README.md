# Цепь Маркова для прогнозирования инцидентов производительности СУБД PostgreSQL

**pg_expecto** — комплекс статистического анализа производительности СУБД PostgreSQL. Данный репозиторий содержит реализацию цепи Маркова для прогнозирования риска возникновения инцидентов производительности на основе наблюдаемых метрик.
